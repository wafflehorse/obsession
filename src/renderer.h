...
#define PUSH_RENDER_GROUP(name) void name(uint32 render_group_id, RenderQuad *instance_data, uint32 instance_count, Vec2 camera_position, RenderGroupOptions opts)
...
#define INITIALIZE_RENDER_GROUP(name) int name(uint32 render_group_id)
typedef INITIALIZE_RENDER_GROUP(InitializeRenderGroup);

#define INITIALIZE_RENDERER(name) int name(Vec2 view_port, Vec2 camera_size, Arena* arena)

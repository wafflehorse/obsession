...
#define PUSH_RENDER_GROUP(name)                                                                                        \
    void name(RenderQuad* instance_data, uint32 instance_count, Vec2 camera_position, RenderGroupOptions opts)
...
#define INITIALIZE_RENDERER(name)                                                                                      \
    int name(Vec2 viewport, Vec2 screen_size, Vec2 camera_size, float camera_zoom, Arena* arena)
